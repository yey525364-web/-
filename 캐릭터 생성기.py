...
st.write("버튼을 눌러 무작위 캐릭터 조합을 만들어보세요!")

# 캐릭터 구성 요소
genders = ["여자", "남자"]
hair_lengths = ["장발", "단발", "숏컷"]
bang_styles = ["반깐", "깐", "올백"]
face_types = ["고양이상", "강아지상", "여우상", "늑대상", "토끼상"]
ages = ["아동기", "청소년기", "청년기"]  # 중년기, 노년기 제외
...
if st.button("🎲 캐릭터 생성"):
    ...
    for i in range(int(game_count)):
        ...
        bang = random.choice(bang_styles)
...
st.caption("💡 Tip: 다시 누르면 새로운 조합이 만들어집니다!")
