...
st.title("유리함수(Rational Function) 학습 앱")
...
x_vals1 = x_vals[x_vals != 0]
y1 = 1 / x_vals1

plt.figure(figsize=(6,4))
plt.plot(x_vals1, y1, label='f(x)=1/x')
...
x_vals2 = x_vals[x_vals != 1]
y2 = (x_vals2+1)/(x_vals2-1)
plt.figure(figsize=(6,4))
plt.plot(x_vals2, y2, label='f(x)=(x+1)/(x-1)')
